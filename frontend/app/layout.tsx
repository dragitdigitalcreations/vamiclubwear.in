...
export const metadata: Metadata = {
  ...
  description:
    "Shop stylish women's clothing online at Vami Clubwear. Discover trendy tops, dresses & oversized t-shirts for modern women in India. Indo-Western fusion, modest fashion & inclusive plus-size aesthetic wear (up to XXXL) handcrafted in Manjeri, Kerala.",
  ...
  keywords: [
    ...
    'fusion wear India',
    'plus size women clothing India',
    'big size dresses for women',
    'plus size Anarkali',
    'XXXL women clothing',
    'curve fashion India',
    'modest fashion',
    ...
    'dupatta',
    'plus size aesthetic fashion',
    'size inclusive women wear',
  ],
...
const ORG_JSONLD = {
  ...
  description:
    'Premium Indo-Western fusion wear, modest fashion, and size-inclusive aesthetic clothing for women — Anarkalis, salwars, shararas, churidars and dupattas in regular and plus sizes up to XXXL.',
  address: {
    '@type': 'PostalAddress',
