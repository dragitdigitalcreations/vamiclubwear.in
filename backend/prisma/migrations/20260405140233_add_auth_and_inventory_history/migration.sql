...
-- CreateEnum
CREATE TYPE "InventoryAction" AS ENUM ('MANUAL', 'ORDER', 'IMPORT', 'RESTOCK', 'ADJUSTMENT');
...
-- CreateIndex
CREATE INDEX "ProductVariant_fabric_idx" ON "ProductVariant"("fabric");

-- CreateIndex
CREATE INDEX "ProductVariant_style_idx" ON "ProductVariant"("style");
