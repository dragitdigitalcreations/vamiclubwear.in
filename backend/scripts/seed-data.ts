...
const CATEGORIES = [
  { name: 'Indo-Western Fusion',  slug: 'indo-western-fusion',  description: 'Contemporary silhouettes with traditional Indian craftsmanship' },
  { name: 'Modest Wear',          slug: 'modest-wear',           description: 'Elegant coverage-first styles for all occasions' },
  { name: 'Bridal Collection',    slug: 'bridal-collection',     description: 'Bespoke bridal & bridesmaids ensembles' },
  { name: 'Dupattas & Drapes',    slug: 'dupattas-drapes',       description: 'Statement dupattas and layering pieces' },
]

const PRODUCTS = [
  {
    name:        'Zari Fusion Suit',
    slug:        'zari-fusion-suit',
    description: 'A contemporary churidar suit featuring intricate zari embroidery on a silk base. Perfect for festive occasions.',
    basePrice:   4800,
    isFeatured:  true,
    category:    'indo-western-fusion',
    variants: [
      { sku: 'VCW-ZFUS-GRN-S-SILK',  size: 'S',  color: 'Emerald Green', colorHex: '#006400', fabric: 'Pure Silk', price: 4800,  stock: 5 },
      { sku: 'VCW-ZFUS-GRN-M-SILK',  size: 'M',  color: 'Emerald Green', colorHex: '#006400', fabric: 'Pure Silk', price: 4800,  stock: 8 },
      { sku: 'VCW-ZFUS-GRN-L-SILK',  size: 'L',  color: 'Emerald Green', colorHex: '#006400', fabric: 'Pure Silk', price: 4800,  stock: 3 },
      { sku: 'VCW-ZFUS-GLD-M-SILK',  size: 'M',  color: 'Gold',          colorHex: '#FFD700', fabric: 'Pure Silk', price: 5200,  stock: 4 },
      { sku: 'VCW-ZFUS-GLD-L-SILK',  size: 'L',  color: 'Gold',          colorHex: '#FFD700', fabric: 'Pure Silk', price: 5200,  stock: 2 },
    ],
  },
  {
    name:        'Mirror Work Lehenga',
    slug:        'mirror-work-lehenga',
    description: 'Velvet lehenga adorned with hand-stitched mirror work. Includes matching blouse and dupatta.',
    basePrice:   12500,
    isFeatured:  true,
    category:    'bridal-collection',
    variants: [
      { sku: 'VCW-MLEH-RED-S-VELV',  size: 'S',  color: 'Ruby Red',    colorHex: '#9B111E', fabric: 'Velvet',    price: 12500, stock: 2 },
      { sku: 'VCW-MLEH-RED-M-VELV',  size: 'M',  color: 'Ruby Red',    colorHex: '#9B111E', fabric: 'Velvet',    price: 12500, stock: 3 },
      { sku: 'VCW-MLEH-RED-L-VELV',  size: 'L',  color: 'Ruby Red',    colorHex: '#9B111E', fabric: 'Velvet',    price: 12500, stock: 1 },
      { sku: 'VCW-MLEH-GLD-M-VELV',  size: 'M',  color: 'Gold',        colorHex: '#FFD700', fabric: 'Velvet',    price: 13000, stock: 0 },
    ],
  },
  {
    name:        'Sheer Chiffon Dupatta',
    slug:        'sheer-chiffon-dupatta',
    description: 'Lightweight chiffon dupatta with delicate border embroidery. Drapes beautifully.',
    basePrice:   1200,
    isFeatured:  false,
    category:    'dupattas-drapes',
    variants: [
  ...
  },
  {
    ...
    variants: [
      ...
      { sku: 'VCW-EGKU-BEG-XL-GORG', size: 'XL', color: 'Beige',       colorHex: '#F5F0DC', fabric: 'Georgette', price: 2800, stock: 3 },
      ...
      { sku: 'VCW-EGKU-NVY-L-GORG',  size: 'L',  color: 'Navy',        colorHex: '#000080', fabric: 'Georgette', price: 2800, stock: 2 },
    ],
  },
  {
    name:        'Velvet Anarkali Set',
    slug:        'velvet-anarkali-set',
    description: 'Flowing velvet anarkali with sequin neckline. A statement piece for weddings and receptions.',
    basePrice:   8500,
    isFeatured:  true,
    category:    'bridal-collection',
    variants: [
